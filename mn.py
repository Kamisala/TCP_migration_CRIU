...
#     h5.setIP('10.0.3.5')
#     net.get('h5').cmd('route add -net 10.0.1.0/24 gw 10.0.3.1 dev h5-eth0')
#     net.get('h5').cmd('route add -net 10.0.2.0/24 gw 10.0.3.1 dev h5-eth0')
#
#     s1.attach('s1-eth5')
#     net.addLink(h5, s1, 1, 5)
#     net.get('h5').cmd('ifconfig h5-eth1 10.0.3.6')
#
#
#     print('already add new host')
#
# def server_udp(net):
#
